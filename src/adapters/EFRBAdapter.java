 ...
 * @author trev
 */
public class EFRBAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K> {
    EFRB_BST<K,K> tree = new EFRB_BST<K,K>();
